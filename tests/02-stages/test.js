...
export let options = {
  stages: [
    { duration: "15s", target: 50 }, // Ramp-up from 1 to 5 VUs in 10s
    { duration: "30s", target: 50 }, // Stay at rest on 5 VUs for 5s
    { duration: "15s", target: 0 } // Ramp-down from 5 to 0 VUs for 5s
  ],
  thresholds: {
    error_rate: ["rate < 0.1"]
  }
